A biblioteca utilizada neste trabalho é a Gumbo, da google disponível no GitHub.
...
Para compilar o programa basta digitar make, é então gerado um arquivo tp3, para executá-lo é necessário passar um arquivo via linha de comando.
